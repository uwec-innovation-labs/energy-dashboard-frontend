  ...
  render() {
    return (
      <div>
        <center>
          {' '}
          <h1> PRIVACY NOTICE (Currently In Template State) </h1>{' '}
        </center>
        <p>
          {' '}
          This privacy notice discloses the privacy practices for Clearwater
          Labs. This privacy notice applies solely to information collected by
        ...
        <center>
          <h5>
            <b>
              ...
              should contact Clearwater Labs immediately.
            </b>
          </h5>
        </center>
      </div>
